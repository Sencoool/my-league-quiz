        ...
        <div className="text-center mb-12">
          <div className="inline-block px-6 sm:px-14 py-6 sm:py-8 rounded-3xl bg-gradient-to-b from-[#1e293b] to-[#0f172a] border border-blue-500/20 shadow-[0_0_50px_rgba(59,130,246,0.15)] relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h1 className="text-3xl sm:text-5xl md:text-6xl font-black tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-300 to-cyan-400 drop-shadow-md mb-4">
                LEADERBOARD
              </h1>

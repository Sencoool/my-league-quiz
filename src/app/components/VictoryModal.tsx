      ...
      <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 pointer-events-none">
        ...
        {user?.isGuest && (
          <div className="w-full px-5 pb-2">
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-900/40 to-indigo-900/40 border border-blue-500/30 p-4 group">
              <div className="absolute inset-0 bg-blue-500/10 opacity-0 group-hover:opacity-100 transition-opacity" />
              <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-3">
                <div className="flex-1">
                  <h3 className="text-white font-bold text-sm mb-1 flex items-center gap-1.5">
                    <span className="text-yellow-400">⚠️</span> Don't lose your progress!
                  </h3>
                  <p className="text-blue-200/70 text-xs leading-relaxed">
                    Guest accounts are cleared every 7 days. Sign in with Google to save your streak and climb the leaderboard.
                  </p>
                </div>
                <button
                  onClick={() => {
                  ...
                  className="shrink-0 relative overflow-hidden bg-white text-black font-bold text-xs px-4 py-2 rounded-xl flex items-center gap-2 hover:bg-gray-100 transition-colors shadow-[0_0_15px_rgba(255,255,255,0.2)]"
                >

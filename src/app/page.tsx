      ...
      <main className="flex flex-col items-center min-h-screen py-2 container mx-auto pt-[100px]">
        ...
        <div className="container mx-auto items-center flex flex-col border-2 border-blue-500 p-4 rounded-lg w-1/2">
          ...
          {search.map((champion: any, index) => (
            <div className="flex items-center gap-4 p-2 border-b bg-neutral-800 border-[#ccc] hover:bg-rose-950 duration-300 cursor-pointer" key={index} onClick={e => handleClick(champion)}>
        ...
        <div className="flex flex-col items-center mt-10 w-1/2">
           Already Answered
           <div>
            {answer.map((champions : any, index) => (
              <div className="flex" key={index}>
                <div className="border-2 border-indigo-500 p-2 max-w-[150px]">
                  <img src={`https://ddragon.leagueoflegends.com/cdn/15.5.1/img/champion/${champions.id}.png`} alt="" className="w-15 object-cover"/>
                </div>
                <div className="border-2 border-indigo-500 p-2 w-[150px]">
                  {champions.name}
                </div>
                <div className="border-2 border-indigo-500 p-2 w-[150px]">  
                  {champions.partype}
